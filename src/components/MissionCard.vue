<template>
  ...
  >
    ...
    />
    <div
      class="w-[95%] lg:w-full p-10 flex flex-col items-start space-y-5 bg-[#232323] text-white rounded-b-lg h-[300px]"
    >
      <h3 class="text-[#379683] text-2xl font-bold">{{ data.title }}</h3>
      <p class="text-white text-justify overflow-hidden after:text-ellipsis">
        {{ data.description }}
      </p>
    </div>
  </div>
